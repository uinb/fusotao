...
pub use fuso_pallet_token;
pub use fuso_pallet_elections;
pub use fuso_pallet_council;
pub use fuso_pallet_samsara;
pub use fuso_pallet_reward;
pub use fuso_pallet_foundation;
...
impl fuso_pallet_elections::Config for Runtime {
	type Event = Event;
...
impl fuso_pallet_samsara::Config for Runtime {
	type Event = Event;
...
impl fuso_pallet_token::Config for Runtime {
	type Event = Event;
	type Balance = Balance;
	type TokenId = u32;
}
...
impl fuso_pallet_council::Config for Runtime {
	type Event = Event;
...
impl pallet_session::Config for Runtime {
	type Event = fuso_pallet_council::Event<Self>;

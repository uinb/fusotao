...
use fuso_runtime::{opaque::Block, AccountId, Balance, BlockNumber, Hash, Index};
...
{
	use fuso_verifier_rpc::{FusoVerifier, FusoVerifierApi};
	...
	io.extend_with(FusoVerifierApi::to_delegate(FusoVerifier::new(client.clone())));
